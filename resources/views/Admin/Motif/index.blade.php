...
@section('content')
    ...
    <div class="page-header">
        <h1 class="page-title">Motif Barang</h1>
        <div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item text-gray">Master Barang</li>
                <li class="breadcrumb-item active" aria-current="page">Motif Barang</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
    ...
    @include('Admin.Motif.tambah')
    @include('Admin.Motif.edit')
    @include('Admin.Motif.hapus')
    ...
    <script>
        ...
        function hapus(data) {
            ...
            $("#vsatuan").html("motif " + "<b>" + data.satuan_nama.replace(/_/g, ' ') + "</b>");
        }
