    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Ubah Motif Barang</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <input type="hidden" name="idsatuanU">
                <div class="form-group">
                    <label for="satuanU" class="form-label">Motif Barang <span class="text-danger">*</span></label>
...
<script>
    function checkFormU() {
        ...
        if (satuan == "") {
            validasi('Motif Barang wajib di isi!', 'warning');
    ...
    function submitFormU() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{url('admin/motif/proses_ubah')}}/" + id,
