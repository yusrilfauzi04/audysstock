...
@section('content')
    ...
    <div class="page-header">
        <h1 class="page-title">Warna Barang</h1>
        <div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item text-gray">Master Barang</li>
                <li class="breadcrumb-item active" aria-current="page">Warna Barang</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
    ...
    @include('Admin.Warna.tambah')
    @include('Admin.Warna.edit')
    @include('Admin.Warna.hapus')
    ...
    <script>
        ...
        function hapus(data) {
            ...
            $("#vmerk").html("warna " + "<b>" + data.merk_nama.replace(/_/g, ' ') + "</b>");
        }
