    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Ubah Warna Barang</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <input type="hidden" name="idmerkU">
                <div class="form-group">
                    <label for="merkU" class="form-label">Warna Barang <span class="text-danger">*</span></label>
...
<script>
    ...
    function submitFormU() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{url('admin/warna/proses_ubah')}}/" + id,
