...
Route::group(['middleware' => 'userlogin'], function () {
    ...
    Route::middleware(['checkRoleUser:/motif,submenu'])->group(function () {
        // Satuan
        Route::resource('/admin/motif', \App\Http\Controllers\Admin\SatuanController::class);
        Route::get('/admin/motif/show/', [SatuanController::class, 'show'])->name('satuan.getsatuan');
        Route::post('/admin/motif/proses_tambah/', [SatuanController::class, 'proses_tambah'])->name('satuan.store');
        Route::post('/admin/motif/proses_ubah/{satuan}', [SatuanController::class, 'proses_ubah']);
        Route::post('/admin/motif/proses_hapus/{satuan}', [SatuanController::class, 'proses_hapus']);
    });

    Route::middleware(['checkRoleUser:/warna,submenu'])->group(function () {
        // Merk
        Route::resource('/admin/warna', \App\Http\Controllers\Admin\MerkController::class);
        Route::get('/admin/warna/show/', [MerkController::class, 'show'])->name('merk.getmerk');
        Route::post('/admin/warna/proses_tambah/', [MerkController::class, 'proses_tambah'])->name('merk.store');
        Route::post('/admin/warna/proses_ubah/{merk}', [MerkController::class, 'proses_ubah']);
        Route::post('/admin/warna/proses_hapus/{merk}', [MerkController::class, 'proses_hapus']);
    });
